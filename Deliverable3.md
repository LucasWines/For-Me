...
**Topic you chose:** Teacher Course Planner

**Sprint Number:** 3

**Scrum Master**: Thuan Nguyen

**Git Master**: Olivier Busuguru

### Sprint Planning (For Sprint 1-3)
Document your Sprint Planning here. Also check the kickoff document for more details on what needs to be done. This is just the documentation. 

**Sprint Goal:** Your Sprint goal
- To create a functional UI.
...
> We added these user stories because they complete the functionality of the UI and populate it with data.

**Why do you think these fit well with your Sprint goal? (details)**

> These fit well because all user stories involve some interaction with the UI or its data.

**Do you have a rough idea what you need to do? (if the answer is no then please let me know on Slack)**

> I believe so, office hours will be attended as needed. 
