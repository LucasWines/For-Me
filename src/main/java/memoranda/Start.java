...
public class Start {
    ...
    static memoranda.ui.App app = null;
    ...
    public static void main(String[] args) {
        ...
        if ((args.length == 0) || (!args[0].equals("-m"))) {
            app = new memoranda.ui.App(true);
        }
        else
            app = new memoranda.ui.App(false);
    }
}
...
class SLThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            e.printStackTrace();
            new memoranda.ui.ExceptionDialog(e, "Cannot create a socket connection on localhost:"+Start.DEFAULT_PORT,
