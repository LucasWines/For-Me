...
public class TaskPanel extends JPanel {
    ...
    /* Code for Toolbar in Tasks, removed for UI changes. US 76, Task 77
    ...
    */
    ...
    void jbInit() throws Exception {
        ...
        newTaskB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_new.png"))));
        ...
        subTaskB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_new_sub.png"))));
...
//        editTaskB.setEnabled(true);
        editTaskB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_edit.png"))));
        ...
        removeTaskB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_remove.png"))));
        ...
        completeTaskB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_complete.png"))));
...
*/
    ...
    ppEditTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_edit.png"))));
    ...
    ppRemoveTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_remove.png"))));
    ...
    ppNewTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_new.png"))));
    ...
    ppAddSubTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_new_sub.png"))));
    ...
    */
	...
	ppCompleteTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_complete.png"))));
	...
	ppCalcTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/todo_complete.png"))));
...
*/
    ...
    void editTaskB_actionPerformed(ActionEvent e) {
        ...
        Point frameLocation = App.getFrame().getLocation();
        dlg.setLocation(
                (frameSize.width - dlg.getSize().width) / 2 + frameLocation.x,
                (frameSize.height - dlg.getSize().height) / 2 + frameLocation.y
        );
        ...
        // Set the end date checkbox based on task dates
        dlg.chkEndDate.setSelected(
                !t.getStartDate().getDate().after(t.getEndDate().getDate())
        );

        // Set the task progress value
        dlg.progress.setValue(t.getProgress());

        // Perform any additional actions for checkbox state
        ...
        // Update the task with dialog values
        CalendarDate startDate = new CalendarDate((Date) dlg.startDate.getModel().getValue());
        CalendarDate endDate = dlg.chkEndDate.isSelected()
        ...
        t.setProgress((int) dlg.progress.getValue());

        // Store the updated task list and refresh the UI
