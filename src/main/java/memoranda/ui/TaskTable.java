...
public class TaskTable extends JTable {
    ...
    void initColumnWidths() {
        ...
        // Course Name (tree column)
        column = getColumnModel().getColumn(1);
        column.setPreferredWidth(200);
        column.setHeaderValue("Course Name");

        // Start Date
        column = getColumnModel().getColumn(2);
        column.setPreferredWidth(100);
        column.setMinWidth(100);
        column.setHeaderValue("Start Date");

        // End Date
        column = getColumnModel().getColumn(3);
        column.setPreferredWidth(100);
        column.setMinWidth(100);
        column.setHeaderValue("End Date");

        // Assignments
        column = getColumnModel().getColumn(4);
        column.setPreferredWidth(100);
        column.setMinWidth(100);
        column.setHeaderValue("Assignments");

        // Holidays
        column = getColumnModel().getColumn(5);
        column.setPreferredWidth(100);
        column.setMinWidth(100);
        column.setHeaderValue("Holidays");

        // Final Exam
        column = getColumnModel().getColumn(6);
        column.setPreferredWidth(100);
        column.setMinWidth(100);
        column.setHeaderValue("Final Exam");

        // Status icon column (keep it narrow)
