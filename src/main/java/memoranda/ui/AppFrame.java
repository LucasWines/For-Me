    ...
    public void showPreferences() {
        ...
        dlg.setVisible(true);
            ...
            protected void ppExport_actionPerformed(ActionEvent e) {
                ...
                Context.put("EXPORT_SPLIT_NOTES", dlg.splitChB.isSelected()); // Use boolean directly
                Context.put("EXPORT_TITLES_AS_HEADERS", dlg.titlesAsHeadersChB.isSelected()); // Use boolean directly
