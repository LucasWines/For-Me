...
public class ResourcesPanel extends JPanel {
  ...
  JMenuItem ppRefresh = new JMenuItem();
    ...
    void jbInit() throws Exception {
        ...
        newResB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/addresource.png"))));
        ...
        refreshB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/refreshres.png"))));
    ...
    ppRemoveRes.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/removeresource.png"))));
    ...
    ppNewRes.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/addresource.png"))));
    ...
    ppRefresh.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/refreshres.png"))));
