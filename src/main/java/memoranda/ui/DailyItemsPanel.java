...
public class DailyItemsPanel extends JPanel {
    ...
    ImageIcon expIcon = new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/exp_right.png")));
    ImageIcon collIcon = new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/exp_left.png")));
    ImageIcon bookmarkIcon = new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/star8.png")));
...
//		Util.debug("currentProjectChanged");
    ...
    public void updateIndicators(CalendarDate date, TaskList tl) {
        ...
        if (date.equals(CalendarDate.today())) {
            if (!tl.getActiveSubTasks(null, date).isEmpty())
