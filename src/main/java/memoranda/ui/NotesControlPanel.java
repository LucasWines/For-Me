...
//    JMenuItem ppInvertSort = new JMenuItem();
    ...
    void jbInit() throws Exception {
        ...
        ppOpenB.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/nopen.png"))));
        ...
        ppAddBkmrk.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/addbookmark.png"))));
        ...
        ppClearNote.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/editdelete.png"))));
        ...
        ppRemoveBkmrk.setIcon(
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/removebookmark.png"))));
...
//		((AppFrame)App.getFrame()).workPanel.dailyItemsPanel.editorPanel.editor.requestFocus();
    ...
    void ppInvertSort_actionPerformed(ActionEvent e) {
        Configuration.put("NOTES_SORT_ORDER", ppInvertSort.isSelected());
