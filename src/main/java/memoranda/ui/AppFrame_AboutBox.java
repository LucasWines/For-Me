...
public class AppFrame_AboutBox extends JDialog implements ActionListener {
  ...
  public AppFrame_AboutBox(Frame parent) {
    ...
    try {
      jbInit();
        ...
        System.err.println("Error initializing AppFrame_AboutBox: " + e.getMessage());
    }
    setSize(400, 500);
  }
  ...
  private void jbInit() throws Exception  {    
    ...
    image = new ImageIcon(Objects.requireNonNull(AppFrame_AboutBox.class.getResource("/ui/memoranda.png")));
