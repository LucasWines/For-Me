...
public class TableSorter extends TableMap {
    ...
    public int compareRowsByColumn(int row1, int row2, int column) {
	    ...
	    if(data.getColumnName(column).equals(Local.getString("Priority"))) {
            Hashtable<String, Integer> priority = new Hashtable<>();
            ...
            Integer s1 = priority.get((String) data.getValueAt(row1, column));
            Integer s2 = priority.get((String) data.getValueAt(row2, column));
