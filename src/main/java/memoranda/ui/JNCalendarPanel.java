...
public class JNCalendarPanel extends JPanel {
  ...
  public Action dayBackAction =
        new AbstractAction(
            "Go one day back",
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/back16.png")))) {
  ...
  public Action dayForwardAction =
        new AbstractAction(
            "Go one day forward",
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/forward16.png")))) {
        public void actionPerformed(ActionEvent e) {
  ...
  public Action todayAction =
        new AbstractAction(
            "Go to today",
            new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/today16.png")))) {
        public void actionPerformed(ActionEvent e) {
  ...
  void jbInit() throws Exception {
    ...
    dayForwardB.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/forward.png"))));
    dayForwardB.setText("");
    ...
    todayB.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/today.png"))));
    todayB.setText("");
    ...
    dayBackB.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/ui/icons/back.png"))));
    dayBackB.setText("");
