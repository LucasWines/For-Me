...
public class TdDialog extends JDialog {
  ...
  void jbInit() throws Exception {
    ...
    header.setIcon(new ImageIcon(Objects.requireNonNull(ImageDialog.class.getResource("/htmleditor/icons/tablebig.png"))));
    ...
    tdBgcolorB.setIcon(new ImageIcon(Objects.requireNonNull(ImageDialog.class.getResource("/htmleditor/icons/color.png"))));
    ...
    trBgcolorB.setIcon(new ImageIcon(Objects.requireNonNull(ImageDialog.class.getResource("/htmleditor/icons/color.png"))));
    ...
    bgColorB.setIcon(new ImageIcon(Objects.requireNonNull(ImageDialog.class.getResource("/htmleditor/icons/color.png"))));
