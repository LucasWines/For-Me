...
public class AddResourceDialog extends JDialog {
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(new ImageIcon(Objects.requireNonNull(AddResourceDialog.class.getResource(
    ...
    void checkOkEnabled() {        
         okB.setEnabled(
            (localFileRB.isSelected() && !pathField.getText().isEmpty()) ||
            (inetShortcutRB.isSelected() && !urlField.getText().isEmpty())
         );
    }
