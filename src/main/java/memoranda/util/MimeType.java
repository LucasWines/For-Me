...
public class MimeType {
    ...
    public ImageIcon getIcon() {
       ...
       if (ip.equals("")) {
        ...
        try {
          icon = new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource(ip)));
        }
        catch (Exception ex) {
          ...
          try {
            ...
            icon = new ImageIcon(Objects.requireNonNull(AppFrame.class.getResource("/util/icons/mimetypes/default.png")));
          }
        }
      }
      else
